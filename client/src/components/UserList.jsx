...
export default function UserList({
    ...
    const [showSelectedUserId, setSelectedUserId] = useState(null)
    ...
    const deleteActionClickNahdler = (userId) => {
        setSelectedUserId(userId)
                ...
                <tbody>
                    {users.map(user => (
                        <UserItem
                            ...
                            onDeleteClick={deleteActionClickNahdler}
