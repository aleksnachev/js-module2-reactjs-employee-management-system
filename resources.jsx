  ...
  // <header class="header">
  //   <div class="logo">
  //     <span class="course">React Exercise - Components Deep Dive</span>
  //   </div>
  // </header>
  ...
  //                 class="icon svg-inline--fa fa-arrow-down Table_icon__+HHgn" role="img"
  ...
  //             </th>
  //             <th>
  //               Email<svg class="icon" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="arrow-down"
  //                 class="svg-inline--fa fa-arrow-down Table_icon__+HHgn" role="img" xmlns="http://www.w3.org/2000/svg"
  //                 viewBox="0 0 384 512">
  //                 <path fill="currentColor"
  //                   d="M374.6 310.6l-160 160C208.4 476.9 200.2 480 192 480s-16.38-3.125-22.62-9.375l-160-160c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0L160 370.8V64c0-17.69 14.33-31.1 31.1-31.1S224 46.31 224 64v306.8l105.4-105.4c12.5-12.5 32.75-12.5 45.25 0S387.1 298.1 374.6 310.6z">
  //                 </path>
  ...
  //                 class="icon active-icon svg-inline--fa fa-arrow-down Table_icon__+HHgn" role="img"
  //                 xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
  //                 <path fill="currentColor"
  //                   d="M374.6 310.6l-160 160C208.4 476.9 200.2 480 192 480s-16.38-3.125-22.62-9.375l-160-160c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0L160 370.8V64c0-17.69 14.33-31.1 31.1-31.1S224 46.31 224 64v306.8l105.4-105.4c12.5-12.5 32.75-12.5 45.25 0S387.1 298.1 374.6 310.6z">
  //                 </path>
                  ...
                  <td className="actions">
                    <button className="btn edit-btn" title="Edit">
                      ...
                      >
                        <path
                          fill="currentColor"
                          d="M490.3 40.4C512.2 62.27 512.2 97.73 490.3 119.6L460.3 149.7L362.3 51.72L392.4 21.66C414.3-.2135 449.7-.2135 471.6 21.66L490.3 40.4zM172.4 241.7L339.7 74.34L437.7 172.3L270.3 339.6C264.2 345.8 256.7 350.4 248.4 353.2L159.6 382.8C150.1 385.6 141.5 383.4 135 376.1C128.6 370.5 126.4 361 129.2 352.4L158.8 263.6C161.6 255.3 166.2 247.8 172.4 241.7V241.7z"
                        ></path>
                      </svg>
                    </button>
                    ...
                    <button className="btn delete-btn" title="Delete">
                      ...
                      >
                        <path
                          fill="currentColor"
                          d="M135.2 17.69C140.6 6.848 151.7 0 163.8 0H284.2C296.3 0 307.4 6.848 312.8 17.69L320 32H416C433.7 32 448 46.33 448 64C448 81.67 433.7 96 416 96H32C14.33 96 0 81.67 0 64C0 46.33 14.33 32 32 32H128L135.2 17.69z"
                        ></path>
                      </svg>
                    </button>
